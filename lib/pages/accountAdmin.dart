                                                    ...
                                                    children: [
                                                      ...
                                                      ClipOval(
                                                        child: CircleAvatar(
                                                            ...
                                                            child:
                                                            // child: isLoadedImage && (platform=='android'|| platform=='ios')
                                                            //     ? Image.file(
                                                            //     image,
                                                            //     fit: BoxFit.cover,
                                                            //     width: 96,
                                                            ...
                                                            //     width: 96,
                                                            //     height: 96)
                                                            (snapshot.data?.path != null) ? Image.memory(
                                                                base64.decode(snapshot.data?.path ?? ''),
                                                                fit: BoxFit.cover,
                                                                width: 96,
                                                                height: 96)

                                                            // : snapshot.data?.path != null ? Image.file(
                                              ...
                                              child: images.length == 1 ?
                                                Container(
                                                    ...
                                                    child:  ClipRRect(
                                                      ...
                                                      child: Image.memory(images[0], width: 285, height: 160,
                                                ...
                                                //containerWidth: 390,
                                                  ...
                                                  itemBuilder: (BuildContext context, int index) {
                                                    ...
                                                    return Container(
                                                      ...
                                                      margin: const EdgeInsets.only(left: 10,right: 10),
                                                      child:  Image.memory(images[index], width: 284, height: 160,
                                                        // ${snapshot.data?.car}[index],
                                                        // centerSlice: Rect.fromPoints(const Offset(50.0, 0.0), const Offset(0, 0)),
                                                        fit: BoxFit.cover,
                                                        alignment: Alignment.centerLeft,
