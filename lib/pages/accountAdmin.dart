...
//class Account extends StatefulWidget {
  ...
  AccountAdmin({Key? key, required this.userId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        routes: {
          ...
          '/members': (context) => MembersAdmin(),
          '/news': (context) => const NewsAdmin(),
          '/shop': (context) => ShopAdmin(),
          '/partners': (context) => PartnersAdmin(),
          ...
          body: FutureBuilder<User>(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                ...
                if(fileExtensionCar1 == 'jpg' || fileExtensionCar1 == 'png' || fileExtensionCar1 == 'svg') {
                ...
                if(snapshot.data?.car2 != null) {
                  ...
                  if(fileExtensionCar2 == 'jpg' || fileExtensionCar2 == 'png' || fileExtensionCar2 == 'svg') {
                ...
                if(snapshot.data?.car3 != null) {
                  ...
                  if (fileExtensionCar3 == 'jpg' || fileExtensionCar3 == 'png' ||
                                                    ...
                                                    children: [
                                                      ...
                                                      ClipOval(
                                                        child: CircleAvatar(
                                                          ...
                                                          child: isLoadedImage ? Image.file(_image, fit: BoxFit.cover, width: 96, height: 96) :
                                                          Text('no image'),
                                            ...
                                            Container(
                                              ...
                                              child: images.length == 1 ?
                                                Container(
                                                    ...
                                                    child:  ClipRRect(
                                                      borderRadius: BorderRadius.all(Radius.circular(20)),
                                                      child: Image.file(images[0], width: 285, height: 160,
                                              ...
                                              : Swiper(
                                                ...
                                                //containerWidth: 390,
                                                  ...
                                                  customLayoutOption:
                                                  CustomLayoutOption(startIndex: 0, stateCount: 2)
                                                    ..addTranslate([
                                                  ...
                                                  itemBuilder: (BuildContext context, int index) {
                                                    ...
                                                    return Container(
                                                      ...
                                                      margin: const EdgeInsets.only(left: 10,right: 10),
                                                      child:  Image.file(images[index], width: 285, height: 160,
                                                        // ${snapshot.data?.car}[index],
                                                        // centerSlice: Rect.fromPoints(const Offset(50.0, 0.0), const Offset(0, 0)),
                                                        fit: BoxFit.cover,
                                                        alignment: Alignment.centerLeft,
...
Future<User> getUser(userId) async {
  ...
  if (response.statusCode == 200) {
    ...
    print('cookie account admin: $cookie');
  ...
  return showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Text('Удалить аккаунт?'.toUpperCase(),
          textAlign: TextAlign.center,
