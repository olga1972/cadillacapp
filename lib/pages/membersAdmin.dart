...
class MembersAdmin extends StatefulWidget {
  MembersAdmin({Key? key}) : super(key: key);
                                                          ...
                                                          Container(
                                                            ...
                                                            child: ListView.builder(
                                                                ...
                                                                itemBuilder: (context, index) {
                                                                  ...
                                                                  var fileExtension = snapshot.data?.users[index].path.substring((snapshot.data?.users[index].path.length)! - 3);
                                                                  ...
                                                                  _image = File('${snapshot.data?.users?[index]?.path}');

                                                                  var fileExtensionCar = snapshot.data?.users[index].car1.substring((snapshot.data?.users[index].car1.length)! - 3);
                                                                  if(fileExtensionCar == 'jpg' || fileExtensionCar == 'png' || fileExtensionCar == 'svg') {
                                                                    isLoadedCar = true;
                                                                  } else {
                                                                    isLoadedCar = false;
                                                                  }

                                                                  _car = File('${snapshot.data?.users?[index]?.path}');
                                                                                ...
                                                                                children:  [
                                                                                  ClipOval(
                                                                                    ...
                                                                                    radius: 48,
                                                                                      ...
                                                                                      child: (isLoadedImage &&_image.existsSync()) ? Image.file(_image, fit: BoxFit.cover, width: 96, height: 96) :
                                                                                      Text('no image'),
                                                                                  ...
                                                                                  isLoadedCar &&_car.existsSync() ? Image.file(_car, fit: BoxFit.cover, width: 157, height: 79) :
                                                                                  Text('no image'),
