...
// }
  ...
  bool isLoadedCar1 = false;
  bool isLoadedCar2 = false;
  bool isLoadedCar3 = false;
        ...
        //   ),
          ...
          body: FutureBuilder<User>(
              ...
              builder: (context, snapshot) {
                ...
                print(snapshot);
                print(snapshot.data?.path);
                var fileExtension = snapshot.data?.path.substring((snapshot.data?.path.length)! - 3);
                if(fileExtension == 'jpg' || fileExtension == 'png' || fileExtension == 'svg') isLoadedImage = true;
                _image = File('${snapshot.data?.path}');
                var fileExtensionCar1 = snapshot.data?.path.substring((snapshot.data?.path.length)! - 3);
                if(fileExtensionCar1 == 'jpg' || fileExtensionCar1 == 'png' || fileExtensionCar1 == 'svg') isLoadedCar1 = true;
                _car1 = File('${snapshot.data?.car1}');
                var fileExtensionCar2 = snapshot.data?.path.substring((snapshot.data?.path.length)! - 3);
                if(fileExtensionCar2 == 'jpg' || fileExtensionCar2 == 'png' || fileExtensionCar2 == 'svg') isLoadedCar2 = true;
                _car2 = File('${snapshot.data?.car2}');
                var fileExtensionCar3 = snapshot.data?.path.substring((snapshot.data?.path.length)! - 3);
                if(fileExtensionCar3 == 'jpg' || fileExtensionCar3 == 'png' || fileExtensionCar3 == 'svg') isLoadedCar3 = true;
                _car3 = File('${snapshot.data?.car3}');
                List<File> images = [_car1, _car2, _car3];
                print(_car3);
                                                      ...
                                                      children: [
                                                        ...
                                                        child: CircleAvatar(
                                                          ...
                                                          backgroundColor: Colors.white,
                                                            child: isLoadedImage ? Image.file(_image, fit: BoxFit.fill, width: 96, height: 96) :
                                                            Text('no image')
                                              ...
                                              Container(
                                                  ...
                                                  itemBuilder: (BuildContext context, int index) {
                                                    ...
                                                    return Container(
                                                      ...
                                                      child:  (isLoadedCar1 && isLoadedCar2 && isLoadedCar3) ? Image.file(images[index], width: 285, height: 160,
                                                        // ${snapshot.data?.car}[index],
                                                        // centerSlice: Rect.fromPoints(const Offset(50.0, 0.0), const Offset(0, 0)),
                                                        fit: BoxFit.fill,
                                                        alignment: Alignment.centerLeft,
                                                      ) : Text('no image'.toUpperCase(),
                                                          textAlign: TextAlign.center,
                                                          style: const TextStyle(
                                                            fontSize: 18.0,
